...
**변성**이란 제네릭의 **타입 파라미터**가 **클래스 계층**과 어떤 **관계**를 맺는지를 설명하는 개념이다.
...
## 제네릭 (Generic)
**제네릭**은 클래스나 메서드가 사용할 **타입을 파라미터화**하여, 코드 작성 시점에 타입을 지정할 수 있다.<br>
...
파라미터화 타입 T가 생산자면 extends를 쓰고 소비자면 super를 사용하는 원칙이다.
